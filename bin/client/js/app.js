...
/***/function (module, exports) {
		...
		return {
			...
			guns: {
				...
				getPositions: function getPositions() {
					...
					for (var i = 0; i < mockup.guns.length; i++) {
						a.push(0);
					}
					return a;
				},
					...
					var process = function () {
						...
						return function () {
							...
							if (isNew) {
								...
								try {
									for (var _iterator4 = z.turrets[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
										var tur = _step4.value;
							...
							for (var _iterator5 = entities[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
								...
								if (e.render.status.getFade() !== 0 && isInView(e.render.x - player.renderx, e.render.y - player.rendery, e.size, true)) {
									...
									if (e.render.textobjs != null) {
										...
										try {
											for (var _iterator6 = e.render.textobjs[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
												var o = _step6.value;
					...
					case 'S':
						{
							...
							if (sync.length < 10) {
								...
								try {
									for (var _iterator8 = sync[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
										var e = _step8.value;
	...
	var drawEntity = function () {
		...
		function drawPoly(context, centerX, centerY, radius, sides) {
			...
			if (Array.isArray(sides)) {
				...
				try {
					for (var _iterator9 = sides[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
				...
				try {
					for (var _iterator10 = sides[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	...
	var gameDraw = function () {
		...
		return function (ratio) {
...

			{
				...
				try {
					for (var _iterator12 = roomSetup[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
    ...
    */
				...
				try {
					for (var _iterator14 = entities[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
     ...
     */
					...
					try {
						for (var _iterator15 = entities[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
...

			{
				...
				try {
					for (var _iterator16 = _gui.skills[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
						var skill = _step16.value;
...

			{
				...
				try {
					for (var _iterator17 = roomSetup[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
						...
						try {
							for (var _iterator19 = row[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
				...
				try {
					for (var _iterator18 = minimap[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
						var o = _step18.value;
...

			{
				...
				try {
					for (var _iterator20 = lb.data[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
...

			{
				...
				if (_gui.upgrades.length > 0) {
					...
					try {
						for (var _iterator21 = _gui.upgrades[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
