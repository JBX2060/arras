			...
			if (Array.isArray(sides)) {
				...
				try {
					for (var _iterator9 = sides[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
						...
						for (var thing in point) {
							console.log(typeof thing === "undefined" ? "undefined" : _typeof(thing));
						}
						console.log(point);
					}
				} catch (err) {
    ...
    */
     ...
     */
...

			{
				...
				try {
					for (var _iterator15 = _gui.skills[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
						var skill = _step15.value;
...

			{
				...
				try {
					for (var _iterator16 = roomSetup[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
				...
				try {
					for (var _iterator17 = minimap[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
						var o = _step17.value;
...

			{
				...
				try {
					for (var _iterator19 = lb.data[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
...

			{
				...
				if (_gui.upgrades.length > 0) {
					...
					try {
						for (var _iterator20 = _gui.upgrades[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
							var model = _step20.value;
